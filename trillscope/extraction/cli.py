...
Examples:
  ...
  python -m trillscope.extraction.cli extract dimex100

  # Extract from ALBAYZIN (uses existing SEO alignment)
  python -m trillscope.extraction.cli extract albayzin

  # Extract from PRESEEA with MFA alignment
  python -m trillscope.extraction.cli extract preseea --use-mfa

  # Extract from PRESEEA without MFA (orthographic only)
  python -m trillscope.extraction.cli extract preseea --no-mfa

  # Extract from all corpora
  python -m trillscope.extraction.cli extract all
"""
    )
