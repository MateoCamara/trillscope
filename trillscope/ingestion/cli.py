...
Examples:
  # Ingest ALBAYZIN corpus
  python -m trillscope.ingestion.cli ingest albayzin

  # Ingest PRESEEA corpus
  python -m trillscope.ingestion.cli ingest preseea

  # Ingest DIMEx100 with speaker metadata CSV
  python -m trillscope.ingestion.cli ingest dimex100 --metadata-csv dimex_speakers.csv

  # Ingest all corpora
  python -m trillscope.ingestion.cli ingest all
"""
    )
