...
erres/mechanism_sex.py. Read-only over existing tables.

Run from repo root:  python -m erres.attrition_sex
"""
...
from erres.quality import QUALITY_FILTER, apply_quality_filter
from src.statistics.data_loader import load_analysis_data
