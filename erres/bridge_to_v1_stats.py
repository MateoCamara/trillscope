...
`src.statistics` reads `acoustic_measurements_<dataset>.parquet` and uses
...
Run:
    python -m erres.bridge_to_v1_stats
"""
...
def main(argv: list[str] | None = None) -> None:
    ap = argparse.ArgumentParser(prog="erres.bridge_to_v1_stats")
