...
``erres.detect_unfiltered``), and for each cell recomputes the sex
...
def _speaker_sex_map() -> dict:
    """speaker_id -> sex using the SAME path as the main analysis (src.statistics
