...
inside the token ROI. See `erres.quality.compute_periodicity_score`.

Downstream consumers apply `erres.quality.apply_quality_filter` to drop
...
def main(argv: list[str] | None = None) -> None:
    ap = argparse.ArgumentParser(prog="erres.build_tokens")
