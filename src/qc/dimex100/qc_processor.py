...
class DIMEx100QCProcessor:
    """QC processor for DIMEx100 dataset."""
    ...
    def __init__(
        ...
        Args:
            index_path: Path to utt_index_dimex100.csv from Block B
    ...
    def process_all(
        ...
        try:
            ...
            result.add_issue(f"Index file not found. Run Block B normalization first.")
            return result
        ...
        for _, row in tqdm(df.iterrows(), total=len(df), desc="QC DIMEx100"):
            try:
